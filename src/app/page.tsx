  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-4 py-12">
      <div className="text-center animate-crt-on">
        ...
        <div className="mx-auto mb-10 max-w-md pixel-card p-5 text-center">
          {" "}
        ...
        <div className="mx-auto mt-16 grid max-w-2xl gap-4 sm:grid-cols-3">
          <div className="pixel-card p-4 text-center">
            <div
              className="mx-auto mb-3 flex h-10 w-10 items-center justify-center pixel-border-sm"
              style={{
            ...
            <h3 className="font-pixel text-[9px] text-retro-text mb-2">
              Grupos
            </h3>
          ...
          <div className="pixel-card p-4 text-center">
            <div
              className="mx-auto mb-3 flex h-10 w-10 items-center justify-center pixel-border-sm"
              style={{
                background: "linear-gradient(135deg, #40ff80, #00e5ff)",
              }}
            >
