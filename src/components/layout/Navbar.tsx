    ...
    <nav className="scanline-beam sticky top-0 z-50 border-b border-retro-border/30 bg-retro-bg/90 backdrop-blur-xl">
      ...
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-3 transition-all hover:opacity-90 group">
          ...
          <div className="cyber-chamfer-sm flex h-8 w-8 items-center justify-center border border-retro-primary/40" style={{background: 'linear-gradient(135deg, rgba(0,255,136,0.2), rgba(139,92,246,0.2))'}}>
          ...
          <span className="hidden sm:inline font-pixel text-[8px] text-retro-text-dim/60">
            NEX™
          </span>
        </Link>
        <AuthButton />
