      ...
      <div className="relative flex items-center gap-3">
        ...
        >
          {session.user.image ? (
            ...
            <div
              className="flex h-7 w-7 items-center justify-center bg-retro-surface font-pixel text-xs text-retro-primary ring-1 ring-retro-border/50 pixel-border-sm"
              aria-hidden="true"
            >
